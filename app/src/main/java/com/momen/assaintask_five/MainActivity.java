...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //image slider
        int images[]={R.drawable.lunce1,R.drawable.salad2,R.drawable.lunce3,R.drawable.lunce5};
        viewFlipper= findViewById(R.id.view_fipar_id);
      /*  for(int i=0;i<image.length;i++){
        ...
        CustomAdapter adapterr = new CustomAdapter(getApplicationContext(), arrayList);
...
//            Glide.with(this).load(R.drawable.cover).into((ImageView) findViewById(R.id.backdrop));
    ...
    //slider
    public  void fliparImages(int image){
